...
/*
ALTER TABLE category
  ALTER COLUMN categoryId int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
*/
-- AUTO_INCREMENT for table 'recipe'
--
ALTER TABLE recipe
   ALTER COLUMN recipeId int  NOT NULL;
--
-- AUTO_INCREMENT for table 'recipecategory'
--
/*
ALTER TABLE recipecategory
  ALTER COLUMN recipeCategoryId int NOT NULL;
*/
